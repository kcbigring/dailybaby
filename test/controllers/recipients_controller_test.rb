...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { create: @recipient.create, delivery_id: @recipient.delivery_id, destroy: @recipient.destroy, user_id: @recipient.user_id }
    end
  ...
  test "should update recipient" do
    patch :update, id: @recipient, recipient: { create: @recipient.create, delivery_id: @recipient.delivery_id, destroy: @recipient.destroy, user_id: @recipient.user_id }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
